...
What the server does on upload and chat. The source of truth is the TypeScript under [`server/src/`](../../server/src/).
...
| Abort / disconnect   | [`server/src/routes/http.ts`](../../server/src/routes/http.ts) `clientDisconnectSignal`                                                                                                                                    |
